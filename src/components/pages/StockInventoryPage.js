            ...
            <div style={styles.mainPage}>
                ...
                <div style={styles.page.right}>
                    <div style={styles.itemCounter}>
                        <FontIcon style={styles.shoppingCart}>shopping_cart</FontIcon> 0 Items
                    </div>
                    <Divider />
                    <div style={styles.recordsBox}>
                        <div>
                            ...
                            <div style={styles.record.right}>$112.00</div>
                            <br />
                            <div style={styles.record.secondLeft}>14 x @ $8.00</div>
                        </div>
                        <div>
                            <div style={styles.record.left}>
                                <Button icon style={styles.removeRecord}>remove_circle</Button>
