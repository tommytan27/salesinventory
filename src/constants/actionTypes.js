const actionTypes = {
    ...
    SIGNAL_R_ADD_USER: 'SIGNAL_R_ADD_USER',
    SIGNAL_R_SAVE_USER: 'SIGNAL_R_SAVE_USER',
    SIGNAL_R_DELETE_USER: 'SIGNAL_R_DELETE_USER',
    SIGNAL_R_ADD_CUSTOMER: 'SIGNAL_R_ADD_CUSTOMER',
    SIGNAL_R_SAVE_CUSTOMER: 'SIGNAL_R_SAVE_CUSTOMER',
    SIGNAL_R_DELETE_CUSTOMER: 'SIGNAL_R_DELETE_CUSTOMER',
    SIGNAL_R_ADD_SUPPLIER: 'SIGNAL_R_ADD_SUPPLIER',
    SIGNAL_R_SAVE_SUPPLIER: 'SIGNAL_R_SAVE_SUPPLIER',
    SIGNAL_R_DELETE_SUPPLIER: 'SIGNAL_R_DELETE_SUPPLIER',
    SIGNAL_R_ADD_BRAND: 'SIGNAL_R_ADD_BRAND',
    SIGNAL_R_SAVE_BRAND: 'SIGNAL_R_SAVE_BRAND',
    SIGNAL_R_DELETE_BRAND: 'SIGNAL_R_DELETE_BRAND',
    SIGNAL_R_ADD_ITEM: 'SIGNAL_R_ADD_ITEM',
    SIGNAL_R_SAVE_ITEM: 'SIGNAL_R_SAVE_ITEM',
    SIGNAL_R_DELETE_ITEM: 'SIGNAL_R_DELETE_ITEM',
    SIGNAL_R_ADD_STOCK: 'SIGNAL_R_ADD_STOCK',
    SIGNAL_R_ADD_CREDIT: 'SIGNAL_R_ADD_CREDIT',
    SIGNAL_R_ADD_SALES: 'SIGNAL_R_ADD_SALES',
    SIGNAL_R_SAVE_CHANGE_AS_CUSTOMER_CREDIT: 'SIGNAL_R_SAVE_CHANGE_AS_CUSTOMER_CREDIT'
};
